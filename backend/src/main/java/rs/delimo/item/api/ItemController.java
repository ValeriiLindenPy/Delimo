...
public class ItemController implements ItemsApi {
    ...
    @Override
    public ResponseEntity<List<ItemPageResponse>> listItems(Integer page, Integer pageSize, String city) {
        return ItemsApi.super.listItems(page, pageSize, city);
    }

    @Override
    public ResponseEntity<List<ItemDto>> searchItems(String text, Integer page, Integer pageSize, String city) {
        return ItemsApi.super.searchItems(text, page, pageSize, city);
    }
}
